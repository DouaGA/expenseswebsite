# Generated by Django 5.2.4 on 2025-08-08 10:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('agent', 'Agent'), ('citizen', 'Citizen')], default='citizen', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipality', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.municipality')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
